...
//
let projectName = 'Findings II'
let projectDesc = "Digital photographs; 2024"
...
function preload(){
    ...
    images[0] = loadImage("./assets/findingsII1.png")
    images[1] = loadImage("./assets/findings3.png")
    images[2] = loadImage("./assets/findingsII2.png")
    images[3] = loadImage("./assets/findingsII3.png")
