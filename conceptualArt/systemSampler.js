...
//
let projectName = 'System Sampler'
let projectDesc = "Rusted hoop, laser-engraved canvas, newsprint, metallized thread, rusted metal, fabrics; 2024"
...
function preload(){
    ...
    images[0] = loadImage("./assets/systemSampler1.png")
    images[1] = loadImage("./assets/systemSamplerA.png")
    images[2] = loadImage("./assets/systemSamplerB.png")
    images[3] = loadImage("./assets/systemSamplerC.png")
...
&& mouseY >= logoYCoord && mouseY <= logoYCoord + logoHeight
    ...
    let backButton = font.textBounds('< Conceptual Art', 0, 0)
    let backButtonX = justifyRight-backButton.w-(gapVar/10)
    let backButtonY = gapVar*2
    text('← Conceptual Art', justifyRight-backButton.w-(gapVar/9), gapVar*2)
    ...
    let workTitle = font.textBounds('< Conceptual Art', gapVar, gapVar*2)
