...
//
let projectName = 'Accumulation'
let projectDesc = "Installation; 2024"
...
function preload(){
    ...
    images[1] = loadImage("./assets/accumulation1.png")
    images[2] = loadImage("./assets/accumulation2.png")
    images[3] = loadImage("./assets/accumulation3.png")
    images[4] = loadImage("./assets/accumulation4.png")
    images[5] = loadImage("./assets/accumulation5.png")
