...
//
let projectName = 'Roots, Flowers'
let projectDesc = "Orchid roots, laser-cut plywood, plaster, metallized thread, iron pan; 2023"
...
function preload(){
    ...
    images[0] = loadImage("./assets/rootsFlowers1.png")
    images[1] = loadImage("./assets/rootsFlowers2.png")
    images[2] = loadImage("./assets/rootsFlowers3.png")
    images[3] = loadImage("./assets/orchidLace2.png")
