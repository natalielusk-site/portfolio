...
//
let projectName = 'Home Artist Book'
let projectDesc = "A collection of illustrations of the comforts of my home and an ode to design choices that wouldn’t otherwise be seen."
...
function preload(){
    ...
    images[0] = loadImage("./assets/homePages1.png")
    images[1] = loadImage("./assets/homePages2.png")
    images[2] = loadImage("./assets/homePages3.png")
