...
//
let projectName = 'Find Your Center Button'
let projectDesc = "A button design that was distributed at tabling events for FSU’s Center for Leadership and Service. "
...
function preload(){
    ...
    images[0] = loadImage("./assets/buttonBox.png")
    images[1] = loadImage("./assets/findYourCenter.png")
