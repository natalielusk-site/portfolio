...
//
let projectName = 'Lace Drawings'
let projectDesc = "A drawing series that explores the aesthetic experience lace, vintage fabrics, and other reclaimed objects produce in contemporary spatial design."
...
function preload(){
    ...
    images[0] = loadImage("./assets/laceDrawings1.png")
    images[1] = loadImage("./assets/laceDrawings2.png")
    images[2] = loadImage("./assets/laceDrawings3.png")
